...
<body>
    <?php include 'WEBPAGEheader.php';
          $id = $_GET['tID'];
          $row = shell_exec("php RABBITMQthreadRabbitMQClient.php \"Thread1\" $id");
          $thread = $row['topic'];
          $desc = $row['threadDesc'];
          ...
          if($method == 'POST'){
            ...
            $sql = shell_exec("php RABBITMQthreadRabbitMQClient.php \"Thread2\" $id");
    ...
    <div class="container-1">
        ...
        <?php
            ...
            $result = shell_exec("php RABBITMQthreadRabbitMQClient.php \"Thread3\" $id");
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="media">
                    <img src="images/WEBPAGEunknown.jpg" width="5%" class="mr-3" alt="">
