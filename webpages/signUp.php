<!DOCTYPE html>
	<html>
		...
		<form action="./userAccountPage.php" method ="post">
			User: <input type="text" name="newUser" id="newUser"><br>
			Email: <input type="text" name+"newEmail" id="newEmail"><br>
			Pass: <input type="text" name="newPass" id="newPass"><br>
		<!-->	Confirm Pass: <input type="text" name="confirm_pass" id="confirm_pass"><br> <-->
