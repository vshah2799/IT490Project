...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="WEBPAGEmarketStyle.css">
</head>

<body>
    <?php
    include 'WEBPAGEheader.php';
    $showAlert = false;
    ...
    <?php
        ...
        //getting info abt cars to display
            ...
            $result = shell_exec("php ../rabbitMQFiles/RABBITMQmarketPlaceRabbitMQClient.php \"Market2\"");
